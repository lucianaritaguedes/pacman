...
global_G1_x = GHOST_BLINKY_POSITION_X;
global_G1_y = GHOST_BLINKY_POSITION_Y;
global_G2_x = GHOST_PINKY_POSITION_X;
global_G2_y = GHOST_PINKY_POSITION_Y;
global_G3_x = GHOST_INKY_POSITION_X;
global_G3_y = GHOST_INKY_POSITION_Y;
global_G4_x = GHOST_CLYDE_POSITION_X;
global_G4_y = GHOST_CLYDE_POSITION_Y;
//updateVar();
//console.log("begin Ghost"+global_email)
...
function resetGhosts() { 
	...
	global_G4_y = GHOST_CLYDE_POSITION_Y;
	updateVar();
	console.log("resetGhost="+global_email)
...
function moveGhost(ghost) {
	...
	global_G4_y = GHOST_CLYDE_POSITION_Y;
	updateVar();
	console.log("moveGhost="+global_email)

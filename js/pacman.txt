...
global_PM_dir = PACMAN_DIRECTION;
global_PM_x = PACMAN_POSITION_X;
global_PM_y = PACMAN_POSITION_Y;
//updateVar();
...
function resetPacman() { 
	...
	global_PM_y = PACMAN_POSITION_Y;
	updateVar();
	console.log("Atualizando variaveis no resetPacman")
	// Luciana's update - end
...
function movePacman(direction) {
	...
	global_PM_y = PACMAN_POSITION_Y;
	updateVar();
	console.log("Atualizando variaveis no movePacman")
	// Luciana's update - end
